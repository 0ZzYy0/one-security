...
import com.one.weixin.message.resp.Article;
import com.one.weixin.message.resp.Music;
import com.one.weixin.pojo.SNSUserInfo;
import com.one.weixin.pojo.WeixinGroup;
import com.one.weixin.pojo.WeixinMedia;
import com.one.weixin.pojo.WeixinOauth2Token;
import com.one.weixin.pojo.WeixinQRCode;
import com.one.weixin.pojo.WeixinUserInfo;
import com.one.weixin.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
		...
		if (null != jsonObject) {
			try {
				...
				//System.out.println("授权测试 JSON === "+jsonObject.toString());
			} catch (Exception e) {
				snsUserInfo = null;
				int errorCode = jsonObject.getInt("errcode");
				String errorMsg = jsonObject.getString("errmsg");
	...
	public static String getMedia(String accessToken, String mediaId, String savePath) {
		...
		try {
			...
			System.out.println("下载媒体文件失败，filePath="+filePath);
			filePath = null;
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wxd45f6e7dd985ee81", "d6162e8837ba8ad60eef8ddb29947dc9").getAccessToken();
...
//		System.out.println(weixinMedia.getCreatedAt());
		 ...
		 * 下载多媒体文件
		 */
		//http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=yMrjUsj3Dn85yhuVE-L8BzGj0cN_pGZ2bzkuj37luGBa3fh_mTRJOGlbzt6kINy6B5NtZeId_s3tRLqE-0AcuQgk_letQdzJ-_NcNbRku-z5X5DmOcguZhEcTN8dFk3mHHFhAIAYYW&media_id=
		getMedia(accessToken, "jelM2wk64balKMOTXmb4Jkp2g1eh1QhHL4G71HQ9nOvrPcZ0chgpTee2CoHeVh8v", "D:\\app/wx");
	}
}
