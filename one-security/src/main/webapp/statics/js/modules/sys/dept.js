...
var vm = new Vue({
    ...
    methods: {
        ...
        add: function(){
            vm.showList = false;
            vm.title = "新增";
            vm.dept = {parentName:null,parentId:0,orderNum:0,province:vm.prov,city:vm.city,district:vm.district};
            vm.getDept();
        },
        update: function () {
            ...
            $.get(baseURL + "sys/dept/info/"+deptId, function(r){
                ...
                //给省市区下拉框赋值
                vm.prov = r.dept.province;
                vm.city = r.dept.city;
                vm.district = r.dept.district;
    ...
    watch: {
    	prov: function (newVal, oldVal) {
            this.updateCity();
            this.updateDistrict();
            this.dept.province = newVal;
        },
        city: function (newVal, oldVal) {
            this.updateDistrict();
            this.dept.city = newVal;
        },
        district: function (newVal, oldVal) {
        	this.dept.district = newVal;
        }
    }
});
var Dept = {
...
Dept.initColumn = function () {
    var columns = [
        ...
        {title: '机构代码', field: 'deptCode', align: 'center', valign: 'middle', sortable: true, width: '180px'},
        ...
        {title: '机构类型', field: 'deptType', align: 'center', valign: 'middle', sortable: true, width: '80px'},
        {title: '机构地址', field: 'deptAddress', align: 'center', valign: 'middle', sortable: true, width: '180px'},
        {title: '负责人', field: 'deptPerson', align: 'center', valign: 'middle', sortable: true, width: '100px'}]
